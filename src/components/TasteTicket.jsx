    ...
    <div className='relative w-full flex flex-col sm:flex-row overflow-hidden'>
        ...
        <div className='flex sm:flex-col justify-center gap-4 size-full'>
          {[
            ...
            <div key={label} className='flex flex-col items-center justify-center gap-1'>
              ...
              <span className='text-xs uppercase tracking-wide text-muted-foreground leading-none'>{label}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      >
        <header className='flex items-baseline justify-between gap-4 pb-3 border-b border-dashed border-white/10'>
          <div>
            <p className='text-xs uppercase tracking-widest text-muted-foreground font-mono'>Flick Cinema</p>
            <h2 className='text-sm font-mono uppercase tracking-wide font-bold text-gray-200 mt-0.5'>
              {profile.displayName}'s taste
            </h2>
          </div>
          <div className='text-right'>
            <p className='text-xs uppercase tracking-widest text-muted-foreground font-mono'>Member Since</p>
        ...
        <div className='grid md:grid-cols-2 gap-4 md:gap-6'>
          <div className='flex flex-col gap-2'>
            <p className='text-xs uppercase tracking-wide font-medium text-muted-foreground'>Loves</p>
          ...
          {worstKeywords.length > 0 && (
            <div className='flex flex-col gap-2'>
              <p className='text-xs uppercase tracking-wide font-medium text-muted-foreground'>Hates</p>
              <div className='flex flex-wrap gap-1.5'>
