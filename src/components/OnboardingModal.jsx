    ...
    return (
      <div className='flex flex-col gap-6'>
        <div className='flex flex-col gap-2'>
          ...
          <p className='text-muted-foreground'>Already rated movies on another platform? Import them to get better recommendations instantly.</p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='grid grid-cols-3 items-center'>
            <button
              onClick={() => setStep(0)}
              className='justify-self-start min-h-11 px-2 text-muted-foreground hover:text-gray-300 transition-colors cursor-pointer'
            >
              Back
            </button>
            {dots}
            <button
              ...
              className='justify-self-end min-h-11 px-2 text-brand hover:text-red-400 transition-colors cursor-pointer'
            >
              Finish
            </button>
          </div>
  ...
  return (
    <div className='flex flex-col gap-6'>
      <div className='flex flex-col gap-2'>
        ...
        <p className='text-muted-foreground'>Helps us tailor your recommendations from the start.</p>
      </div>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='grid grid-cols-3 items-center'>
          <button
            onClick={() => onComplete()}
            className='justify-self-start text-sm font-medium min-h-11 px-2 text-muted-foreground hover:text-gray-300 transition-colors cursor-pointer'
            disabled={isLoading}
          >
            Skip
          </button>
